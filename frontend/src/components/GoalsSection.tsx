...
export function GoalsSection({ goals, onGoalClick }: GoalsSectionProps) {
  return (
    <div data-squad-context="goal">
      <div className="flex items-center justify-between mb-6">
        <div className="flex items-center gap-3">
          ...
          <h2 className="text-xl text-white">Savings Goals</h2>
        </div>
        <Button 
          size="sm" 
          className="bg-gradient-to-r from-teal-500/20 to-cyan-500/20 hover:from-teal-500/30 hover:to-cyan-500/30 text-teal-400 border border-teal-500/30"
