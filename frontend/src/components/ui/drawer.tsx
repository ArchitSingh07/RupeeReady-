  ...
  return (
    <DrawerPortal data-slot="drawer-portal">
      ...
      <DrawerPrimitive.Content
        ...
        className={cn(
          "group/drawer-content bg-[#141414]/95 backdrop-blur-xl border-white/10 text-gray-100 fixed z-50 flex h-auto flex-col",
        ...
        {...props}
      >
        <div className="bg-white/20 mx-auto mt-4 hidden h-1.5 w-[60px] shrink-0 rounded-full group-data-[vaul-drawer-direction=bottom]/drawer-content:block" />
        {children}
      </DrawerPrimitive.Content>
    </DrawerPortal>
  );
